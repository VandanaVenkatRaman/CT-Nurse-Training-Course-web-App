...
<!DOCTYPE html>
    ...
    <body>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-table"></i><a id="course_1" class="courseTraining" href="">Course</a></li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-table"></i><a id="course_2" class="courseTraining_2" href="">Course</a></li>
        ...
        <div id="right-panel" class="right-panel">
			...
			<div class="content mt-3" id="c_1" style="display:none;">
				   <iframe width="750" height="600" scrolling="no" frameborder="0"  style="overflow:hidden;" src="https://my.visme.co/projects/kkzxj9jk-18r276j7gn3756qz">
				        </iframe><br> <br>
			</div>
        ...
        <script src="../lib/dashboard/js/main.js"></script>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
					...
					$(".courseTraining").click(function (e) {
					...
					$(".courseTraining_2").click(function (e) {
						$("#questionAndAnswerResult").hide();
                        $("#mandatoryQuestionAnswer").hide();
						 $("#quiz").hide();
						 $("#course").hide();
